...
* Add middleware to move request to required field [Nitish Agarwal]
* Add file-upload hook (only organisation) [Nitish Agarwal]
* Add logo field to organization model [Nitish Agarwal]
